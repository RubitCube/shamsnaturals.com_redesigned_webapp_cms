...
const NewArrivalsPage = () => {
  ...
  const structuredData = {
    ...
    description:
      "Discover our latest collection of eco-friendly bags and sustainable products. New arrivals featuring premium jute bags, cotton bags, and eco-conscious solutions.",
