...
const BannerCarousel = ({ banners }: BannerCarouselProps) => {
  ...
  const getBannerImageUrl = (path: string) => {
    ...
    const baseUrl = apiUrl.replace("/api/v1", ""); // REMOVE /api/v1

    const cleanPath = path.replace(/^public\//, ""); // REMOVE wrong public/
    ...
    <div className="relative w-full overflow-hidden rounded-3xl h-[240px] sm:h-[320px] md:h-[400px] lg:h-[520px] max-w-full">
      {banners.map((banner, index) => {
        ...
        const bannerImageUrl = banner.image_path.startsWith("http")
          ? banner.image_path
          : `${apiUrl}/storage/${banner.image_path.replace(/^public\//, '')}`;*/

        const bannerImageUrl = getBannerImageUrl(banner.image_path);
        const isActive = index === currentIndex;
        const textLines = parseBannerText(banner);
        const hasText =
          textLines.length > 0 &&
          textLines.some((line) => line.trim().length > 0);
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                {index === 0 && hasText && (
                  <>
                    {textLines[0] && textLines[0].trim() && (
                      <div
                        className="carousel4head fadeInLeft animated"
                    ...
                    {textLines[1] && textLines[1].trim() && (
                      <div
                        className="carousel4subhead01 fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[1]}</h1>
                      </div>
                    ...
                    {textLines[2] && textLines[2].trim() && (
                      <div
                        className="carousel4subhead fadeInLeft animated"
                    ...
                    {textLines[3] && textLines[3].trim() && (
                      <div
                        className="carousel4subhead02 fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[3]}</h1>
                      </div>
                ...
                {index === 1 && hasText && (
                  <>
                    {textLines[0] && textLines[0].trim() && (
                      <div
                        className="carousel3head fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[0]}</h1>
                      </div>
                    ...
                    {textLines[1] && textLines[1].trim() && (
                      <div
                        className="carousel3subhead01 fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[1]}</h1>
                      </div>
                    ...
                    {textLines[2] && textLines[2].trim() && (
                      <div
                        className="carousel3subhead fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[2]}</h1>
                      </div>
                    ...
                    {textLines[3] && textLines[3].trim() && (
                      <div
                        className="carousel3subhead02 fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[3]}</h1>
                      </div>
                ...
                {index === 2 && hasText && (
                  <>
                    {textLines[0] && textLines[0].trim() && (
                      <div
                        className="carouselhead fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[0]}</h1>
                      </div>
                    ...
                    {textLines[1] && textLines[1].trim() && (
                      <div
                        className="carouselsubhead01 fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[1]}</h1>
                      </div>
                    ...
                    {textLines[2] && textLines[2].trim() && (
                      <div
                        className="carouselsubhead fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[2]}</h1>
                      </div>
                    ...
                    {textLines[3] && textLines[3].trim() && (
                      <div
                        className="carouselsubhead02 fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[3]}</h1>
                      </div>
                ...
                {index >= 3 && hasText && (
                  <>
                    {textLines[0] && textLines[0].trim() && (
                      <div
                        className="carousel2head fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[0]}</h1>
                      </div>
                    ...
                    {textLines[1] && textLines[1].trim() && (
                      <div
                        className="carousel2subhead01 fadeInLeft animated"
                        style={{ animationDelay: "0.1s" }}
                      >
                        <h1>{textLines[1]}</h1>
                      </div>
                    ...
                    {textLines[2] && textLines[2].trim() && (
                      <div
                        className="carousel2subhead fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[2]}</h1>
                      </div>
                    ...
                    {textLines[3] && textLines[3].trim() && (
                      <div
                        className="carousel2subhead02 fadeInLeft animated"
                        style={{ animationDelay: "0.5s" }}
                      >
                        <h1>{textLines[3]}</h1>
                      </div>
